...
export default function Footer(){
    ...
    return <>
            <Flex style={{boxShadow:'1px 1px 10px 0.1px gray'}} borderTopRadius={'xl'} alignItems={'center'} justifyContent={'space-around'} m='-10px' h='10vh' w='100vw' bg='white' position={'fixed'} bottom={'0px'}>
                    <Link to={'/home'}>
